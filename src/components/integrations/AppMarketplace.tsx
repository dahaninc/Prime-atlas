...
const APPS: MarketplaceApp[] = [
  ...
  },
  {
    ...
    tagline: "Investment analysis reports · Claude-powered · one click",
    category: "AI Tools",
    markets: ["Global"],
    description:
      "Generates institutional-grade investment analysis reports from any Prime Atlas opportunity score in seconds. Powered by Claude.",
    longDescription:
      "Investment Analysis AI takes a municipality's full score breakdown — opportunity, growth, infrastructure, development, liquidity, and risk — and generates a structured investment analysis report covering market context, investment thesis, risk factors, and sensitivity analysis. Output is a downloadable PDF formatted to institutional standards.",
    rating: 4.9,
    ratingCount: 2105,
    installs: 12340,
    version: "3.0.1",
    tags: ["AI", "Report", "Claude", "PDF", "Pro"],
    featured: true,
    price: "Pro",
    requiredTier: "explorer",
    ...
    steps: [
      ...
      "Click 'Generate Investment Analysis Report' in the action bar.",
      "Claude processes score data → report generates in ~8 seconds.",
