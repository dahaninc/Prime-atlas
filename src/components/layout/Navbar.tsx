    ...
    <>
      ...
      <nav className="sticky top-0 z-50 border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between h-14">
          ...
          <div className="hidden md:flex items-center gap-0.5">
            ...
            <Link
              ...
              className={cn("flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm transition-colors",
                pathname === "/listings" ? "text-foreground bg-secondary" : "text-muted-foreground hover:text-foreground hover:bg-secondary/50"
              )}
            >
          ...
          {/* Mobile — slim auth action (no hamburger; nav is bottom dock) */}
          <div className="md:hidden">
            {user ? (
              ...
              <Link
                href="/auth/signup"
                className="text-xs font-semibold bg-pa-green text-pa-navy px-3 py-1.5 rounded-md hover:bg-pa-green/90 transition-colors"
              >
                Get access
              </Link>
            )}
