...
export const metadata: Metadata = {
  ...
  description:
    "The Bloomberg for Future Investment Opportunities in Spain. Ranked municipalities, AI-generated investment theses, and real-time signals — before the market recognises them. Costa Blanca, Alicante, Valencia.",
};

const INDEXES = [
  { href: "/rankings", label: "Spain Opportunity Index", description: "Top municipalities by composite score" },
      ...
      <main>
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 py-20 sm:py-28 text-center">
          <div className="inline-flex items-center gap-2 border border-pa-green/30 bg-pa-green/5 text-pa-green text-xs font-mono px-3 py-1.5 rounded-full mb-8">
            ...
            Live signals · Costa Blanca · Alicante · Valencia
          </div>
          ...
          <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
            The Bloomberg for Future Investment Opportunities. Ranked municipalities,
            AI-generated investment theses, and real-time signals — before the market recognises them.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/rankings" className="border border-border text-foreground px-8 py-3.5 rounded-lg hover:bg-secondary transition-colors text-sm">
              Spain Opportunity Index →
            </Link>
          </div>
        ...
        <section className="border-t border-border py-14">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <p className="text-xs text-muted-foreground font-mono uppercase tracking-widest text-center mb-8">
              Top-ranked municipalities right now
            </p>
            ...
            <p className="text-center mt-6">
              <Link href="/rankings" className="text-sm text-pa-green hover:underline">
                View full Spain Opportunity Index →
              </Link>
            </p>
          </div>
        </section>
        ...
        {/* Indexes */}
        <section className="border-t border-border py-14 bg-secondary/20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <section className="border-t border-border py-20 text-center">
          <div className="max-w-2xl mx-auto px-4 sm:px-6">
            <h2 className="text-3xl font-bold mb-4">Never miss the next Sagunto.</h2>
            <p className="text-muted-foreground text-sm mb-8">
              Amazon confirmed. Port expanding. Mediterranean Corridor arriving. Sagunto scored 91/100
              in January. The market caught up in May. prime-atlas subscribers saw it first.
            </p>
