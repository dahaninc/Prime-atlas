        ...
        <main className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
          ...
          <section className="border border-[#1E4A7A] rounded-xl p-8 bg-gradient-to-br from-[#0E1E32] to-[#0B1628] text-center mb-10">
            ...
            <p className="text-zinc-500 text-sm max-w-xl mx-auto mb-6 leading-relaxed">
              Every market in this report has a full deal card in the Deal Board: clickable evidence layers, editable pro-forma with yield-on-cost and margin-on-cost, and — on Institutional — one-click Investment Analysis Report export. Free tier access to the Deal Board itself — no credit card.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                ...
                },
                {
                  ...
                  desc: "Institutional feature. Export a structured investment analysis report with scores, pro-forma, and checked evidence layers in under 3 seconds.",
                },
              ].map((f) => (
                <div
                  key={f.title}
