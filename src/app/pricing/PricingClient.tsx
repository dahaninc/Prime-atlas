...
const TIERS = [
  {
    ...
    features: [
      ...
      "Deal Screener — 5 analyses per month",
      "Underpriced feed — top 3 deals (covered US submarkets)",
      "Email support",
    ],
    locked: [
      "Higher contact-reveal & screener limits",
      "Full 3/5/10-yr exit architecture",
      "Saved searches & deal alerts",
      "Full comparables data",
      "OM / rent-roll parsing",
      "Full underpriced feed (covered US submarkets)",
  ...
  },
  {
    ...
    features: [
      ...
      "Deal Screener — 100 analyses/mo with OM/rent-roll parsing",
      "Full underpriced feed (covered US submarkets)",
      "Priority email support",
    ],
    locked: [
      "API data access",
      "Institutional-grade data & report export",
      "Portfolio tracking",
    ],
  },
  {
    ...
    features: [
      ...
      "API data access",
      "Unlimited Deal Screener runs",
      "Investment Analysis Report export (Word)",
      "Portfolio tracking (up to 50 properties)",
      "Multi-seat team access — coming soon",
...
const COMPARISON_ROWS = [
  ...
  { label: "Contact reveals",                      explorer: "10/mo", professional: "100/mo",   institutional: "Unlimited" },
  ...
  { label: "Underpriced feed (ZIP-comp basis, covered US submarkets)", explorer: "Top 3 teaser", professional: "Full feed", institutional: "Full feed" },
  { label: "Deal Screener — analyses/mo",          explorer: "5/mo", professional: "100/mo",    institutional: "Unlimited" },
  { label: "OM / rent-roll / T12 parsing",         explorer: false,  professional: true,        institutional: true },
  { label: "API data access",                      explorer: false,  professional: false,       institutional: true },
  { label: "Investment Analysis Report export",    explorer: false,  professional: false,       institutional: true },
  { label: "Portfolio tracking",                   explorer: false,  professional: false,       institutional: true },
  { label: "Team seats",                           explorer: false,  professional: false,       institutional: "Coming soon" },
        ...
        <div className="space-y-5">
          {[
            ...
            },
            {
              ...
              a: "When you want the seller's or agent's contact details for a listing, that counts as one reveal. Explorer members get 10 per month, Professional gets 100 per month, and Institutional is unlimited.",
            },
            {
            ...
            },
            {
              ...
              a: "Multi-seat team access is coming soon to Institutional. Today, Institutional is a single-user plan with the full platform, unlimited Screener runs, and Investment Analysis Report export. Want early access for your team? Contact us at institutional@prime-atlas.com.",
            },
          ].map(({ q, a }) => (
